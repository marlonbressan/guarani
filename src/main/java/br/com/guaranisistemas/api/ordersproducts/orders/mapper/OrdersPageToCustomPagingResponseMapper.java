...
/**
 * Mapper interface named {@link OrdersPageToCustomPagingResponseMapper} for converting {@link CustomPage<Orders>} to {@link CustomPagingResponse<OrdersResponse>}.
 */
@Mapper
public interface OrdersPageToCustomPagingResponseMapper {
     ...
     *
     * @param orders The list of orders objects to convert.
     ...
     */
    static OrdersPageToCustomPagingResponseMapper initialize() {
        return Mappers.getMapper(OrdersPageToCustomPagingResponseMapper.class);
    }
